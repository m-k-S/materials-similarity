...
class EGNN(nn.Module):
    def __init__(self, in_node_nf, hidden_nf, device='cpu', act_fn=nn.SiLU(), n_conv_layers=3, n_linear_layers=1, attention=False,
        ...
        self.coords_range_layer = float(coords_range/n_conv_layers)
    ...
    def forward(self, h, x, edge_index, batch, node_mask=None, edge_mask=None):
        # Edit Emiel: Remove velocity as input
